<template>
  <div class="container-fluid mt-5">
    <card>
      ...
      <!-- ----------------- FOOTER -------------- -->
      <p>Harga tersebut <input style="border: 1px solid white;" @change="updateBA(detailNewsData.news_no)" v-model="dataBA.ppn"></p>
      ...
      <div class="row">
        <div class="col-3">
          <div style="width: 100%;">
            <div style="">
              ...
              <p style="text-align: center; margin-bottom: 100px; margin-top: -15px;">PT. BUANA CENTRA KARYA</p>
            </div>
          </div>
          <div style="width: 100%; page-break-after: always;">
            <div style="">
              <p style="text-align: center; border-bottom: 1px solid black;">{{dataBA.nama}}<br></p>
        ...
        <div class="col-3">
          <div style="width: 100%;">
            <div style="text-align: center;">
              ...
              <p style="text-align: center; margin-bottom: 100px; margin-top: -15px;">{{detailNewsData.client_name}}</p>
            </div>
          </div>
          <div style="width: 100%;">
            <div style="">
        ...
        <div class="col-3" v-if="detailNewsData.client_name == 'PT. KRAKATAU PIPE INDUSTRIES'">
          <div style="width: 100%;">
            <div style="text-align: center;">
              <p style="text-align: center; margin-top: 70px"></p>
        ...
        <div class="col-3" v-if="detailNewsData.client_name == 'PT. KRAKATAU PIPE INDUSTRIES' && detailNewsData.prod_class == 'Tolling'">
          <div style="width: 100%;">
            <div style="text-align: center;">
              <p style="text-align: center; margin-top: 70px"></p>
